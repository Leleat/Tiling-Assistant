...
var Handler = class TilingKeybindingHandler {
	...
	_onCustomKeybindingPressed(shortcutName) {
		...
		// layout overview
		} else if (shortcutName === MainExtension.TILING.LAYOUTS_OVERVIEW) {
		...
		// open the appDash consecutively to tile to a layout
			...
			MainExtension.tilingLayoutManager.startTilingToLayout(Number.parseInt(shortcutName.substring(15)));
			return;
		}
