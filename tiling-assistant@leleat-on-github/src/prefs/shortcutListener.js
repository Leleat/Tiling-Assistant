...
export const ShortcutListener = GObject.registerClass(
    ...
    class ShortcutListener extends Adw.ActionRow {
        ...
        static stopListening() {
            ...
            ShortcutListener.listener.setKeybindingLabel(
                ShortcutListener.listener.getKeybindingLabel(),
            );
        ...
        initialize(key, setting) {
            ...
            this.connect('realize', () =>
                this.get_root().add_controller(this._eventKeyController),
            );
